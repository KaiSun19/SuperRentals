...
module('Integration | Component | share-button', function (hooks) {
  ...
  hooks.beforeEach(function () {
    ...
    this.tweetParam = (param) => {
      ...
      return url.searchParams.get(param); // returns params of the tweet intent api
    };
  });
  ...
  test('basic usage', async function (assert) {
    ...
    assert.strictEqual(this.tweetParam('url'), MOCK_URL.href); // tests to see if the created tweetParams matches the mock url
  });
