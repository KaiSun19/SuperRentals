...
module('Unit | Model | rental', function (hooks) {
  ...
  test('it shows the correct type in model ', function (assert) {
    let store = this.owner.lookup('service:store'); // store is an instance of the ember data and is a service object so can be accessed globally in the app
